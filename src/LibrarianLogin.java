    ...
    public LibrarianLogin() {
        ...
        btnLogin.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if (DB.validate(SID,password,2)) {
                    LibrarianMenu.main(SID);
                    frame.dispose();
                } else {
                    JOptionPane.showMessageDialog(LibrarianLogin.this, "Sorry, SID or Password Error", "Login Error!", JOptionPane.ERROR_MESSAGE);
                    textField.setText("");
