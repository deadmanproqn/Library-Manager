...
/**
 * ViewIssued Frame- Librarian version
 */
public class ViewIssuedLib extends JFrame {
    ...
    public static void main(Librarian librarian) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ViewIssuedLib frame = new ViewIssuedLib(librarian);
     ...
     * Create the frame.
     */
    public ViewIssuedLib(Librarian librarian) {
        ...
        try {
            ...
            ResultSet rs=librarian.issue(con);
